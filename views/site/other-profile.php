      ...
      <div class="col-md-4 mb-3">
        ...
        <div class="card mt-3">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              <span class="text-secondary"><a href="<?= Url::toRoute(['qweston']) ?>">Сообщить об ошибке</a></span>
            </li>
          </ul>
        </div>
      </div>
          ...
          <section id="marzen" class="tab-panel">
              ...
              <div class="forqr">
                <div class="cardplatqr">
                  ...
                  $tempDir = "qrcodes/";
                  $tempDirget = "../qrcodes/";
                  $codeContents = 'ST00012|Name=СНТ Завьяловские сады|PersonalAcc=40703810668000001278|BankName=УДМУРТСКОЕ ОТДЕЛЕНИЕ N8618 ПАО СБЕРБАНК|BIC=049401601|CorrespAcc=30101810400000000601|KPP=184101001|PayeeINN=1831167843|lastName=' . $userModel->name . ' ' . $userModel->last_name . '|payerAddress=' . $streetNow . '|Purpose=Оплата взносов 2024-2025г.';
                  ...
                  $codeContentsq = 'ST00012|Name=СНТ Завьяловские сады|PersonalAcc=40703810668000001278|BankName=УДМУРТСКОЕ ОТДЕЛЕНИЕ N8618 ПАО СБЕРБАНК|BIC=049401601|CorrespAcc=30101810400000000601|KPP=184101001|PayeeINN=1831167843|lastName=' . $userModel->name . ' ' . $userModel->last_name . '|payerAddress=' . $streetNow . '|Purpose=Оплата дополнительного взноса 2024-2025г.';
            ...
            <section id="two" class="tab-panel">
              ...
              <a href="/pdfFromSber/СберБизнес. Выписка за 2023.09.01-2025.04.27 счёт 40703810668000001278.pdf">Открыть выписку в новом окне</a>
              <br><br>
              <embed src="/pdfFromSber/СберБизнес. Выписка за 2023.09.01-2025.04.27 счёт 40703810668000001278.pdf" width="100%" height="2100px" />
