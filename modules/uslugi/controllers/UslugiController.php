...
class UslugiController extends Controller
{
    ...
    public function actionMyUslugi()
    {
        $searchModel = new UslugiUSearch();
        $dataProvider = $searchModel->searchMyUslugi($this->request->queryParams);
        
        return $this->render('my-uslugi', [
    ...
    {
        $model = new Uslugi();
        $model->address = Yii::$app->user->identity->street;
